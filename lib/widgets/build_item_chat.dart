...
Widget buildItemChat(BuildContext context, int index,
  ...
  var progressIndicator = CircularProgressIndicator(
      ...
      AlwaysStoppedAnimation<Color>(Theme
          .of(context)
          .primaryColor)); //Right (user) message

  return Stack(
      children: <Widget>[
        Row(
          mainAxisAlignment:
          userId == documentSnapshot["fromId"] ? MainAxisAlignment.end : MainAxisAlignment.start,
          children: <Widget>[
              ...
              child: Column(
                ...
                children: <Widget>[
                  Text(
                    ...
                    textAlign: userId == documentSnapshot["fromId"] ? TextAlign.end : TextAlign.start,
                  ),
                ],
              ),
              width: 200,
                ...
                onPressed: () {
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (context) =>
                          FullScreenWidget(
                            child: documentSnapshot["content"],
                          ),
                    ),
                  );
                },
